<template>
    <div class="surface-section px-4 py-3 md:px-6 lg:px-8">
        ...
        <div class="grid py-2">
            ...
            <div class="col-12 md:col-4 flex flex-column align-items-center mb-3 md:mb-0">
                <div class="flex align-items-center">
                    <img src="@/assets/coupon.png" width="180"
                        class="inline-flex align-items-center justify-content-center bg-cyan-500 mb-4">
                    <span class="text-900 text-xl font-medium mb-3">Discount 30%
                        <p class="text-600 line-height-3 py-0 m-0 px-3" style="font-size:15px;">SOLAOบ้านเจ๊...</p></span>
                </div>
                <div class="flex align-items-center">
                    <img src="@/assets/coupon.png" width="180"
                        class="inline-flex align-items-center justify-content-center bg-cyan-500 mb-4">
                    <span class="text-900 text-xl font-medium mb-3">Discount 30%
                        <p class="text-600 line-height-3 py-0 m-0 px-3" style="font-size:13px;">SOLAOคันคลอง...</p></span>
                </div>
                <div class="flex align-items-center">
                    <img src="@/assets/coupon.png" width="180"
                        class="inline-flex align-items-center justify-content-center bg-cyan-500 mb-4">
                    <span class="text-900 text-xl font-medium mb-3">Discount 30%
                        <p class="text-600 line-height-3 py-0 m-0 px-3" style="font-size:15px;">SOUELMIND...</p></span>
                </div>
